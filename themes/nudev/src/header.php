		...
		<div class="wrapper">
			...
			<?php if(function_exists("wp_header")){wp_header();} ?><header>
				...
				<?php
					...
					$return = wp_remote_get('https://alerts.northeastern.edu/alert-panel/?cache=no');
					// $return = wp_remote_get('http://alerts.local/alert-panel?cache=no');
