<?php
	...
	$slideLinks = '';
	$i = 1;
	foreach($stories[0]['block_slide'] as $bS){
		$slideLinks .= '<li'.($i == 1?' class="active"':'').' data-id="'.$i.'" role="listitem"><a href="'.$bS['block_slide_link'].'" title="'.strtolower($bS['block_slide_title']).' [will open in new tab/window]" aria-label="'.strtolower($bS['block_slide_title']).' [will open in new tab/window]" target="_blank" rel="noopener"><span>'.$bS['block_slide_title'].'</span></a></li>';
		$i++;
	}
