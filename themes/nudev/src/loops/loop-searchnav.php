...
<div id="nu__searchbar" style="<?=$style?>"><section><a href="javascript:void(0);" class="blur blurclosepanel">blur top to close search panel</a><form name="nu__searchbar-form" id="nu__searchbar-form" action="/search" method="get"><div><button type="submit" title="Click here or press enter to perform search" aria-label="Click here or press enter to perform search" tabindex="-1">&#xE8B6;</button><input type="text" name="query" id="superquery" title="Enter your search query here and press enter" aria-label="Enter your search query here and press enter" /><label for="superquery" class="label">Search</label><button class="reset hidden" type="reset" title="Click here to clear current search" aria-label="Click here to clear current search" tabindex="-1">&#xE5C9;</button></div><p>Commonly searched items</p><ul><?=$popular?></ul></form><a href="javascript:void(0);" class="blur blurclosepanel">blur bottom to close search panel</a></section></div>
