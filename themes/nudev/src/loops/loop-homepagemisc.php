<?php
	...
	// $cta = 'COVID-19<br />Critical Information<br /><span>Last updated: March 4</span>';
	$cta = 'Learn More';
	...
	echo sprintf(
		...
		,'COVID-19<br />Critical Information<br /><span>Last updated: March 4</span>'
		,$story['block_slide'][0]['block_slide_link']
		// ,str_replace(array('<br />','<span>','</span>'),' ',$story['block_slide'][0]['block_slide_title'])
		,'COVID-19 Critical Information Last updated: March 4'
