<?php
	...
	// $guide = '<article id="article-%s"><div class="bgimage" style="%s %s"></div><div class="nu__panel-content"><div><h2><span>%s</span></h2><a href="" title="" aria-label="">Learn More</a></div></div>%s<div class="gradient"></div>%s</article>';

	$guide = '<article id="article-%s"><div class="bgimage" style="%s %s"></div><div class="nu__panel-content"><div><h2><span>%s</span></h2><a href="%s" title="Learn more - %s%s" aria-label="Learn more - %s%s"%s>Learn More</a></div></div>%s<div class="gradient"></div></article>';
