				...
				<article>
					...
					<div class="searcharea">
						...
						<form name="homepagesearch" action="<?=site_url()?>/search" method="get">
							<input type="text" name="query" id="inpagequery" placeholder="Campus Visit, Academic Calendar ..." title="Enter your search query here" aria-label="Enter your search query here" /><label for="inpagequery" class="label">Search</label>
							<input name="gosearch" id="gosearch" type="submit" value="Search" title="Click here to search" aria-label="Click here to search">
						</form>
					</div>
