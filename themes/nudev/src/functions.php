...
// this will help to control user access to specific custom post types and users
function posts_for_current_author($query) {
  global $pagenow;
	global $typenow;

	// we only want to restrict author access on certain post types
	if($typenow == 'globalcontent'){
