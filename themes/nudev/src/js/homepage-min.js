...
o(this).attr("style","background-image:url("+a[0]+");")}),
...
"block"==o("div.takeover").css("display")&&setTimeout(function(){a()},i),o.post("/wp-content/themes/nudev/src/hprotatordata.php",function(t){rotators=JSON.parse(t);
