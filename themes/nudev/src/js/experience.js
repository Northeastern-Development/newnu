...
s("section.leftright > div").empty(),// clear out the content to make sure that it is truly gone, before setting it again
...
s("section.leftright > div").html(t),// set the new data
